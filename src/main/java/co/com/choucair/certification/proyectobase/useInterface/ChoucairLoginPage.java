...
public class ChoucairLoginPage extends PageObject {
    ...
    public static final Target INPUT_USER = Target.the("WHERE DO WE WRITE THE USER").located(By.id("user-name"));
    public static final Target INPUT_PASSWORD = Target.the("WHERE DO WE WRITE THE PASSWORD").located(By.id("password"));
    public static final Target ENTER_BUTTON = Target.the("BOTTON TO CONFIRM LOGIN").located(By.xpath("//*[@id=\"login-button\"]"));
