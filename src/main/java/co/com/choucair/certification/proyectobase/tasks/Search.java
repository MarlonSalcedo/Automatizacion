...
import static co.com.choucair.certification.proyectobase.useInterface.ChoucairLoginPage.ENTER_BUTTON_COMPLETE;
import static co.com.choucair.certification.proyectobase.useInterface.SearchCoursePage.*;

public class Search implements Task {
    public static Search onThePage() {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(LOGIN_BUTTON ),
                ...
                Enter.theValue("marlonsalcedo10400734834@gmail.com").into(INPUT_EMAIL),
